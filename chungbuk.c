...
void send_14data(int sd, FILE *fp1, char str_tmp1[BUF_SIZE], char str[BUF_SIZE]);
int main(int argc, char *argv[])
{
    ...
    send_13data(sd,fp,str_tmp[BUF_SIZE],*str[BUF_SIZE]);
    send_14data(sd,fp1,str_tmp1[BUF_SIZE],*str1[BUF_SIZE]);
